...
if running_config:
    ...
    print("Comparing running configuration with startup configuration:")
    ...
    try:
        ...
        print("Stored offline configuration file not found.")
    ...
    def compare_with_hardening_advice():
        ...
        try:
            ...
            if hardening_advice:
                print("Comparing running configuration with Cisco device hardening advice:")
    ...
    print("Enabling syslog for event logging and monitoring:")
    configure_syslog()
