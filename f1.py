...
Traceback (most recent call last):
  File "task.py", line 329, in <module>
    display_menu()
  File "task.py", line 319, in display_menu
    compare_with_hardening_advice()
NameError: name 'compare_with_hardening_advice' is not defined

Failed to configure syslog: No existing session
Failed to configure event logging: No existing session
